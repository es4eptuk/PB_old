...
$no_lid = [
    ...
    "доп" => ["facial","person","identity","лица","voice","rights","poor","200 thousand dollars","200000$","ملمحي","مرحبا","انا موافق","مرحبا","موافق","اريد التعامل","ما المطلوب مني لأفعله","200000 دولار","درست","وجه","مظهر خارجي","صوت بشري","صورة","الصحيح","مهلا","شكرا لك","باع","يتصل","يشترى","قبول","طلبي","فروش","صورت","صدا","ظاهر","تصویر","هی","متشکرم","تماس گرفتن","نوشتن","خرید","المشروع","پروژه","أنا موافق","الظروف","شرایط","کار کنید","عمل","قضية","مورد"],
];
