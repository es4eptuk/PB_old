        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <!-- /.form-group -->
              <a href="./archive.php">Сбросить фильтр</a>
            </div>
            <!-- /.col -->
            <div class="col-md-6">
              <div class="form-group">
...
var id_s = 0;
 ...
 $( "#filter_user" )
  .change(function () {
   ...
   if (robot==0) {
        window.location.href = "./archive.php?user="+user;
   } else {
        window.location.href = "./archive.php?user="+user+"&robot="+robot;
  ...
  .change(function () {
   ...
   if (user==0) {
        window.location.href = "./archive.php?robot="+robot;
   } else {
        window.location.href = "./archive.php?user="+user+"&robot="+robot;
