...
class Writeoff { 
    ...
    function add_writeoff($json) {
        ...
        $this->query = "INSERT INTO `writeoff` (`id`, `category`, `description`,`total_price`,`check`,`robot`, `update_date`, `update_user`) VALUES (NULL, '$category','$description','$total_price','$check','$robot', '$date', $user_id)";
     ...
     function add_log($param) {
        ...
        switch ($type) {
            case "edit":
                ...
                $this->query = "INSERT INTO `pos_log` (`id`, `id_pos`, `old_count`, `new_count`, `title`, `update_date`, `update_user`) VALUES (NULL, '$id', '$old_count', '$count', '$title', '$date', '$user_id')";
                break;
            case "reserv":
            ...
            case "writeoff":
                ...
                $this->query = "INSERT INTO `pos_log` (`id`, `id_pos`,  `new_count`, `title`, `update_date`, `update_user`) VALUES (NULL, '$id', '$old_count', '$title', '$date', '$user_id')";
                break;
            case "addmission":
                $tmp = $old_count+$count;
                $title = $title.": $count шт. Новое значение - > $old_count";
