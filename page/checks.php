...
class Checks
{
    ...
    function add_check_on_robot($id_row, $robot, $id, $value, $number, $remont, $kit)
    {
        ...
        // 1029 упаковка/наклеить транспортировочные наклейки
        // 1058 упаковка/наклеить транспортировочные наклейки
        // 1220 упаковать
        // 1370 Упаковка Rooky (R)
        // 1371 Упаковка Rooky (L)
        // 1325 Упаковка Robox
        // 1318 Упаковка Robo-C
        // 1162 упаковка/наклеить транспортировочные наклейки
        // 1218 упаковка короба с доп оборудованием
        // 547 ?
        $array_end = [547,104,313,552,745,668,684,788,805,961,978,1029,1058,1220,1370,1371,1325,1318,1162,1218];
        //if (($id == 104 || $id ==313 || $id ==552 || $id ==745 || $id ==668 || $id ==684 || $id ==788 || $id ==805 || $id ==961 || $id ==978 || $id ==1029 || $id ==547) && $value == 1) {
        if (in_array($id, $array_end) && $value == 1) {
