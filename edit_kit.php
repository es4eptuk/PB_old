...
$id = $_GET['id'];
$kit = $position->get_info_kit($id);
$kit_id = $kit['id_kit'];
$kit_title = $kit['kit_title'];
$kit_category = $kit['kit_category'];
$kit_version = $kit['kit_version'];

$edit_eneble = $position->get_edit_eneble_kit($id);
$del_eneble = $position->get_del_eneble_kit($id);
?>
						...
						<div class="box box-warning">
							...
							<div class="box-body">
                                    ...
                                    foreach ($arr_pos as &$value) {
                                        ...
                                        $remove = ($edit_eneble) ? '<i class="fa fa-2x fa-remove" style="cursor: pointer;" id="'.$value['id_row'].'"></i>' : '';
									...
									<div class="box-footer">
										...
										<button type="button" class="btn btn-primary btn-danger pull-right" id="delete" name="" <?= ($del_eneble) ? '' : 'disabled' ?>>Удалить</button>
									</div>
