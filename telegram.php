...
require_once __DIR__ . "/vendor/autoload.php";
    ...
    //echo $supportTimeStart;
    
    //$ticket_on_robot = $tickets->get_tickets(38, 0, 0, "update_date", "DESC", 0,0,0,"P",0,1); 
    
    //print_r ($ticket_on_robot);
    //$arr_id = $robots->telegram_get_id('123622748');
   ...
   // $keyboard_start_ru = [["Создать обращение"],["Информация по роботу"],["Документация"]]; //Клавиатура
    ...
    if($text){
         if ($text == "/start") {
            ...
            $reply_markup = $telegram->inlineKeyboardMarkup(['inline_keyboard' => $keyboard_lang_en]);
