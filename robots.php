                ...
                foreach ($arr as &$robot) {
                    ...
                    if ($robot['progress']!=100 || $check_show_all== 1) {
                        ...
                        unset($date);
                         ...
                         $edit = ($userdata['user_id'] == 75 || $userdata['user_id'] == 14 || $userdata['user_id'] == 17 || $userdata['user_id'] == 77 || $userdata['user_id'] == 106) ? "<a href='./edit_robot.php?id=".$robot['id']."'><i class='fa fa-2x fa-pencil' style='cursor: pointer;'></i></a>" : "";
                         if ($robot['delete']==2) {
                             $print = "";
                             $check = "";
