...
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
           // $id_assembly = $line['id_assembly'];
            ...
            $id = $line['id'];
            $query2 = "SELECT robots.version, robots.number, robots.name, tickets.description, tickets.result_description, tickets.date_create FROM tickets INNER JOIN robots ON tickets.robot = robots.id WHERE tickets.robot = $id AND tickets.date_create > '2019-07-05 00:00:00' AND tickets.assign_time != '0000-00-00 00:00:00'";
