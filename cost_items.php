 ...
 <?php include 'template/header.html' ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box-body">
            <div class="btn-group">
                      <button type="button" class="btn btn-default">За сегодня</button>
                      <button type="button" class="btn btn-default">За неделю</button>
                      <button type="button" class="btn btn-default">За месяц</button>
                    </div>
          <div class="row">
