          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="pos" class="table table-responsive">
                ...
                $arr = $position_warehouse->get_pos_in_category($_GET['id'], 0, 0, $archive);
        ...
        id: id_pos
          ...
          .done(function( data ) {
              if (data=="false") {alert( "Data Loaded: " + data ); }
                ...
                window.location.href = "./pos_warehouse.php?id="+category;
              }
          });
